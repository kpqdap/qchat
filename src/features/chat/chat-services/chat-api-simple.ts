...
//             role: "assistant",
//           });
//           await updateChatThreadIfUncategorised(chatThread, lastHumanMessage.content);
//         } catch (e) {
//         }
//       },
//     });
...
import { PromptGPTProps } from "./models";
import { updateChatThreadIfUncategorised } from "./chat-utility";
import { translator } from "./chat-translator-service"; // Ensure this is your translation service
